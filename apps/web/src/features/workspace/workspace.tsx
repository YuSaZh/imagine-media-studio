...
export function Workspace() {
  ...
  const go = (path: string) => { setSearch(''); setFilter('all'); setSelected([]); setSelecting(false); setMenuOpen(false); void navigate(path); mainRef.current?.scrollTo({ top: 0 }); };
