...
export function parameterPresets(capabilities: JsonObject, providerType = '', modelId = ''): ModelParameter[] {
  ...
  list('resolution', '分辨率', resolutionCapability.success ? resolutionCapability.data.values : capabilities.resolutions);
  if (resolutionCapability.success && resolutionCapability.data.allowCustomDimensions) {
    ...
    else rules.push({ path: 'resolution', label: '分辨率', type: 'text' });
  }
