...
const PR7_VISUAL_REPORT = [
  ...
  '## Reference states',
  '',
  'Grok Imagine remains the only UI/UX reference. The available public evidence supports the broad white canvas, compact Gallery, mobile two-column layout, and bottom Composer relationships. The private authenticated reference package is unavailable, so authenticated Gallery, Viewer, settings, task, standalone, and keyboard states have no reference ID and strict L3/L4 comparison is deferred.',
  '',
  '## Implementation evidence',
  '',
  'Screenshots use the fixed PR1 Mock fixture with animations disabled. CI also runs production cold-offline and unknown-marker checks at every PR7 viewport.',
  '',
  ...
  '',
  'No pixel comparison is claimed because the authenticated baseline is unavailable. Dynamic-media masks are recorded for future reference comparison; no Shell, Composer, control, or status region is masked.',
  '',
  '## Known differences',
  '',
  ...
  '',
  'The implementation and geometry gates pass. Strict reference pixel comparison and real-device validation are intentionally not claimed.',
  '',
].join('\n');
