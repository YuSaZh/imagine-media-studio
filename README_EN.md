...
- Preferences can group editing series into one gallery entry with a count badge and a recently viewed, newest, or original cover; active editor generation shows only status and elapsed time. The nested concurrent-image option groups images from one recorded submission, including retries and reloads.
